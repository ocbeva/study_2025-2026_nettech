...
![Основные Характеристики](image/1.png){ #fig:001 width=80% }
...
![Подсеть А](image/2.png){ #fig:001 width=80% }
...
![подсеть Б ](image/3.png){ #fig:001 width=80% }
...
![Подсеть С](image/4.png){ #fig:001 width=80% }
...
![сеть 2](image/5.png){ #fig:001 width=80% }
...
![выделение 30 узлов](image/6.png){ #fig:001 width=80% }
...
![Сеть 10.10.1.0/26](image/7.png){ #fig:001 width=80% }
...
![Выделение 14 узлов](image/8.png){ #fig:001 width=80% }
...
![характеристика IPv4-подсети](image/9.png){ #fig:001 width=80% }
...
![разбиение](image/10.png){ #fig:001 width=80% }
...
![Топология лабораторного стенда](image/11.png){ #fig:001 width=80% }
...
![Процесс настройки интерфейсов FRR](image/15.png){ #fig:005 width=80% }

Конфигурация маршрутизатора отображается через `show running-config`.

![Вывод running-config](image/16.png){ #fig:006 width=70% }

Команда `show interface brief` показывает состояние и назначенные адреса.

![Информация об интерфейсах FRR](image/17.png){ #fig:007 width=70% }
...
![Ping и trace с PC1](image/18.png){ #fig:008 width=80% }
...
![ARP-трафик](image/18.png){ #fig:009 width=90% }
...
![Назначение IPv6-адресов на VyOS](image/22.png){ #fig:014 width=85% }

После применения конфигурации был выполнен просмотр интерфейсов.

![Вывод show interfaces на VyOS](image/23.png){ #fig:015 width=70% }
...
![Ping и trace с PC4](image/24.png){ #fig:016 width=80% }
...
![PC1 вывод show ip](image/25.png){ #fig:019 width=75% }

Для PC2 настроены адреса второй подсети:

![PC2 вывод show ip](image/26.png){ #fig:020 width=75% }

Используемая схема сети:

![Топология сети](image/27.png){ #fig:021 width=70% }
...
![Настройка VyOS интерфейсов](image/28.png){ #fig:022 width=80% }
...
![Проверка IPv4 с PC1](image/29.png){ #fig:025 width=70% }
